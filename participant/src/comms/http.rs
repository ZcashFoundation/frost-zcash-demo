        ...
        let session_id = match self.session_id {
            ...
            None => {
                ...
                if r.session_ids.len() > 1 {
                    ...
                    return Err(eyre!("User has no current session active. The Coordinator should either specify your username, or manually share the session ID which you can specify with --session_id").into());
                }
                r.session_ids[0]
            }
        };
